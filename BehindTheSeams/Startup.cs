...
namespace BehindTheSeams
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IFabricImageRepository, FabricImageRepository>();
            services.AddTransient<IPatternImageRepository, PatternImageRepository>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "BehindTheSeams", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "BehindTheSeams v1"));
            }
